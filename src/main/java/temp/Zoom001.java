...
public class Zoom001 extends Application {
    ...
    EventHandler<MouseEvent> mouseHandler = new EventHandler<MouseEvent>() {
        ...
        public void handle(MouseEvent mouseEvent) {
            ...
            */
                double axisShift = getSceneShift(yAxis);
                double newLowerBound, newUpperBound;
                double Tgapy = yAxis.getHeight()/(yAxis.getUpperBound() - yAxis.getLowerBound());
                newLowerBound = yAxis.getUpperBound() - ((rectinitY.get() - axisShift) / Tgapy);
                newUpperBound = yAxis.getUpperBound() - (( rectY.get() - axisShift) / Tgapy);
