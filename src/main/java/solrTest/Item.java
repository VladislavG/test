...
public class Item {
    ...
    private String ol_version;
    private String active;
    private String currency;
    private String delivery_frequency;
    private String delivery_frequency_description;
    private String full_export_pars;
    private String full_export_risk;
    ...
    private String is_imi_internal;
    ...
    private String minimal_denomination;
    private String nominal_amount;
    ...
    public String getOl_version() {
        return ol_version;
    }

    public void setOl_version(String ol_version) {
    ...
    public String getFull_export_pars() {
        return full_export_pars;
    }

    public void setFull_export_pars(String full_export_pars) {
        this.full_export_pars = full_export_pars;
    }

    public String getFull_export_risk() {
        return full_export_risk;
    }

    public void setFull_export_risk(String full_export_risk) {
    ...
    public String getInitial_load() {
        return initial_load;
    }

    public void setInitial_load(String initial_load) {
    ...
    public String getIs_derived() {
        return is_derived;
    }

    public void setIs_derived(String is_derived) {
        this.is_derived = is_derived;
    }

    public String getIs_imi_internal() {
        return is_imi_internal;
    }

    public void setIs_imi_internal(String is_imi_internal) {
    ...
    public String getIm_internal() {
        return im_internal;
    }

    public void setIm_internal(String im_internal) {
    ...
    public String getUbs_relevant() {
        return ubs_relevant;
    }

    public void setUbs_relevant(String ubs_relevant) {
    ...
    public String getMinimal_denomination() {
        return minimal_denomination;
    }

    public void setMinimal_denomination(String minimal_denomination) {
