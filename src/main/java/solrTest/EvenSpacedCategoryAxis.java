 ...
 * @since JavaFX 2.0
 */
public final class EvenSpacedCategoryAxis extends Axis<String> {
...
//                    rangeValid = false;
    ...
    private DoubleProperty startMargin = new StyleableDoubleProperty(5) {
        ...
        @Override public CssMetaData<EvenSpacedCategoryAxis,Number> getCssMetaData() {
            return StyleableProperties.START_MARGIN;
        }

        @Override
        public Object getBean() {
            return EvenSpacedCategoryAxis.this;
        }
    ...
    private BooleanProperty gapStartAndEnd = new StyleableBooleanProperty(true) {
        ...
        @Override public CssMetaData<EvenSpacedCategoryAxis,Boolean> getCssMetaData() {
     ...
     */
    public EvenSpacedCategoryAxis(ObservableList<String> categories) {
    ...
    private double calculateNewSpacing(double length, List<String> categories) {
        ...
        if(side != null && categories != null) {
            ...
            newCategorySpacing = (bVal == 0) ? 2 : (length-getStartMargin()-getEndMargin()) / bVal;
        }
...
//        for(String cat : data) {
     ...
     * is a EvenSpacedCategoryAxis this will be the nearest value.
     *
    ...
    /**
     * Get the display position of the zero line along this axis. As there is no concept of zero on a EvenSpacedCategoryAxis
     * this is always Double.NaN.
     *
     * @return always Double.NaN for EvenSpacedCategoryAxis
     */
    ...
    private static class StyleableProperties {
        private static final CssMetaData<EvenSpacedCategoryAxis,Number> START_MARGIN =
                new CssMetaData<EvenSpacedCategoryAxis,Number>("-fx-start-margin",
                        SizeConverter.getInstance(), 5.0) {

                    @Override
                    public boolean isSettable(EvenSpacedCategoryAxis n) {
                        return n.startMargin == null || !n.startMargin.isBound();
                    }

                    @Override
                    public StyleableProperty<Number> getStyleableProperty(EvenSpacedCategoryAxis n) {
                        return (StyleableProperty<Number>)n.startMarginProperty();
                    }
                };

        private static final CssMetaData<EvenSpacedCategoryAxis,Number> END_MARGIN =
                new CssMetaData<EvenSpacedCategoryAxis,Number>("-fx-end-margin",
                        SizeConverter.getInstance(), 5.0) {
        ...
        private static final CssMetaData<EvenSpacedCategoryAxis,Boolean> GAP_START_AND_END =
                new CssMetaData<EvenSpacedCategoryAxis,Boolean>("-fx-gap-start-and-end",
                    ...
                    @Override
                    public StyleableProperty<Boolean> getStyleableProperty(EvenSpacedCategoryAxis n) {
